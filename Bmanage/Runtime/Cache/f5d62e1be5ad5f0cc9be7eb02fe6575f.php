...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.0" href="/">青果旗下后台管理系统</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">QG</a> <span class="Hui-subtitle l">V1.0</span> <span class="Hui-userbox"><span class="c-white">超级管理员：<?php echo $_SESSION['admin']['name'];?></span> <a class="btn btn-danger radius ml-10" href="<?php echo U('Public/loginout');?>" title="退出"><i class="icon-off"></i> 退出</a></span> <a aria-hidden="false" class="Hui-nav-toggle" id="nav-toggle" href="#"></a> </header>
      ...
      <dl id="menu_2">
        ...
        <dd>
          <ul>
            ...
            <li><a _href="<?php echo U('Bookcase/index');?>" href="javascript:void(0)">书架管理</a></li>
            <li><a _href="<?php echo U('Xw/index');?>" href="javascript:void(0)">文章管理</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu_1">
