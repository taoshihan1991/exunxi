...
<body>
<div class="pd-20">
  <form class="Huiform" id="loginform" action="<?php echo U('Bookcase/update',array('id'=>$info['id']));?>" method="post">
    <table class="table table-border table-bordered table-bg">
      ...
      <tbody>
        <tr>
          ...
          <td><input name="casename" id="casename" class="input-text" type="text" autocomplete="off" placeholder="" value="<?php echo ($info["casename"]); ?>" tabindex="3" datatype="*" nullmsg="请输入书架名称！" errormsg="请输入书架名称！"> 
          </td>
        </tr>
        <tr>
          <th class="text-r">排序：</th>
          <td><input name="sort" id="sort" class="input-text" type="text" value="<?php echo ($info["sort"]); ?>"> 
          </td>
        </tr>
