...
<title><?php echo ($channel["classname"]); ?>-<?php echo ($webtitle); ?></title>
	...
	<div class="container">
		<div class="content-wrap">
			<div class="content">
				<div class="archive-header">
					<h1><a href=""><?php echo ($channel["classname"]); ?></a></h1>
				</div>
				<?php $i=0;?>
				...
				<div class="excerpt <?php if($i==1): ?>cur<?php endif; ?>">
					...
					<p class="t-tag">
						<span class="muted">[<a href="<?php echo U('List/index',array('cid'=>$v['classid']));?>" rel="category tag"><?php echo ($v["classname"]); ?></a>]</span>
						<span class="muted"><i class="icon-eye-open icon12"></i> <?php echo ($v["hits"]); ?> 浏览</span>
						<span class="muted"><i class="icon-time icon12"></i> <?php echo (date("Y年m月d日",$v["time"])); ?></span>
					</p>
					<p class="note"><?php echo ($v["content"]); ?>
					</p>
					<p class="t-line">
						<span class="t">标 签<span class="t-arrow"></span>
						</span>
						  <a href="<?php echo U('view/index',array('id'=>$v['id']));?>" class="tag" rel="tag">感动人的小说</a>
					</p>
		...
		<div class="sidebar">
			<div class="widget widget_categories">
				<h3 class="widget_tit"><?php echo ($channel["classname"]); ?>分类</h3>
				<ul>
					<li><a href="">书目推荐</a></li>
					<li><a href="">书目推荐</a></li>
					<li><a href="">书目推荐</a></li>
